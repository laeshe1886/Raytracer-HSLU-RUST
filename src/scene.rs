...
impl Scene {
    ...
    pub fn monkey_scene(width: usize, height: usize) -> Self {
        ...
        objects.push(
            Box::new(Plane {
                ...
                material: Material::Lambert {
                    ambient: 0.1,
                    albedo: Vec3::new(0.1, 0.1, 0.15), // Die Farbe des Bodens
                },
            })
        );
        ...
        let lights = vec![Vec3::new(10.0, 15.0, 10.0), Vec3::new(-10.0, 10.0, -5.0)];
    ...
    pub fn glas_scene(width: usize, height: usize) -> Self {
        let mut objects: Vec<Box<dyn Hittable>> = Vec::new();
        // Hellgrauer, marter Boden fuer optimale Schattensichtbarkeit
        objects.push(
            Box::new(Plane {
        ...
        // Glas-Mesh mit der zuvor ermittelten Absorption
        let fallback = Material::Dielectric {
            refractive_index: 1.5,
            absorption: Vec3::new(0.5, 0.5, 0.5),
        };
        objects.push(Box::new(Mesh::from_obj("assets/Glas.obj", fallback)));

        // Goldene Kugel als Referenzobjekt
        objects.push(
            Box::new(Sphere {
        ...
        // Kamera weiter weg (Z = -20.0) und etwas hoeher (Y = 5.0) fuer eine bessere Uebersicht
        let camera = Camera::new(
            Vec3::new(0.0, 5.0, -20.0), // Kameraposition
            Vec3::new(0.0, 1.5, 0.0), // Blickpunkt (Zentrum der Szene)
            Vec3::new(0.0, 1.0, 0.0), // Up-Vektor
            35.0, // FOV
            (width as f32) / (height as f32)
        );
        ...
        Self {
            objects,
            lights: vec![Vec3::new(-15.0, 20.0, 10.0), Vec3::new(15.0, 15.0, -10.0)],
            camera,
            background_color: Color::new(0.02, 0.02, 0.05),
        }
    }
    ...
    pub fn birds_eye_scene(width: usize, height: usize) -> Self {
        ...
        objects.push(
            Box::new(Plane {
                ...
                normal: Vec3::new(0.0, 1.0, 0.0),
                material: Material::Lambert { ambient: 0.1, albedo: Vec3::new(0.1, 0.1, 0.1) },
            })
        );
        ...
        for i in 0..5 {
            ...
            let mat = if i % 2 == 0 {
                Material::Metal { specular_color: Vec3::new(0.8, 0.8, 0.9), glossiness: 0.0 }
            } else {
                Material::Dielectric { refractive_index: 1.5, absorption: Vec3::new(0.0, 0.0, 0.0) }
            };
            Self::add_cube_mesh(
                &mut objects,
                Vec3::new(x, -2.0, -12.0),
                Vec3::new(x + 1.2, i as f32, -10.0),
                mat
            );
        }
        ...
        Self {
            objects,
            lights: vec![Vec3::new(0.0, 25.0, -10.0), Vec3::new(10.0, 10.0, 0.0)],
            camera,
            background_color: Color::new(0.0, 0.0, 0.02),
        }
    }
    ...
    pub fn close_up_scene(width: usize, height: usize) -> Self {
        ...
        objects.push(
            Box::new(Sphere {
                ...
                material: Material::Dielectric {
                    refractive_index: 1.5,
                    absorption: Vec3::new(0.2, 0.05, 0.05),
                },
            })
        );
        objects.push(
            Box::new(Sphere {
                center: Vec3::new(1.2, -0.5, -1.0),
                radius: 0.4,
                material: Material::Metal {
                    specular_color: Vec3::new(0.9, 0.9, 1.0),
                    glossiness: 0.0,
        ...
        Self {
            objects,
            lights: vec![Vec3::new(5.0, 5.0, -5.0), Vec3::new(-5.0, 2.0, 2.0)],
            camera,
            background_color: Color::new(0.05, 0.05, 0.08),
        }
    }
    ...
    pub fn frogs_eye_scene(width: usize, height: usize) -> Self {
        ...
        objects.push(
            Box::new(Plane {
                ...
                normal: Vec3::new(0.0, 1.0, 0.0),
                material: Material::Lambert { ambient: 0.1, albedo: Vec3::new(0.2, 0.2, 0.2) },
            })
        );
        for i in -3..4 {
            let mat = Material::BlinnPhong {
                ambient: 0.05,
            ...
            Self::add_cube_mesh(
                &mut objects,
                Vec3::new((i as f32) * 5.0 - 0.5, -1.0, -20.0),
                Vec3::new((i as f32) * 5.0 + 0.5, 12.0, -19.0),
                mat
            );
        }
        ...
        Self {
            objects,
            lights: vec![Vec3::new(0.0, 20.0, -12.0)],
            camera,
            background_color: Color::new(0.01, 0.01, 0.03),
        }
    }
    ...
    pub fn wide_angle_scene(width: usize, height: usize) -> Self {
        ...
        objects.push(
            Box::new(Plane {
                point: Vec3::new(0.0, -2.0, 0.0),
                normal: Vec3::new(0.0, 1.0, 0.0),
                material: Material::Lambert { ambient: 0.1, albedo: Vec3::new(0.15, 0.15, 0.15) },
            })
        );
        for z in 0..12 {
            let color = if z % 2 == 0 {
            ...
            objects.push(
                Box::new(Sphere {
                    center: Vec3::new(-5.0, 0.0, (z as f32) * -5.0),
                    radius: 1.2,
                    material: Material::Metal { specular_color: color, glossiness: 0.0 },
                })
            );
            objects.push(
                Box::new(Sphere {
        ...
        Self {
            objects,
            lights: vec![Vec3::new(0.0, 15.0, 0.0)],
            camera,
    ...
    pub fn default_scene(width: usize, height: usize) -> Self {
        ...
        objects.push(
            Box::new(Sphere {
                ...
                radius: 2.0,
                material: Material::Metal {
                    specular_color: Vec3::new(0.9, 0.9, 0.9),
                    glossiness: 0.02,
                },
            })
        );
        ...
        objects.push(
            Box::new(Plane {
                point: Vec3::new(0.0, -2.0, 0.0),
                normal: Vec3::new(0.0, 1.0, 0.0),
                material: Material::Lambert { ambient: 0.2, albedo: Vec3::new(0.4, 0.4, 0.4) },
            })
        );
        ...
        Self {
            objects,
            lights: vec![Vec3::new(10.0, 10.0, 5.0), Vec3::new(-10.0, 10.0, 5.0)],
            camera,
            background_color: Color::new(0.08, 0.08, 0.1),
        }
    }
}
